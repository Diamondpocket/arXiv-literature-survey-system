...
def generate_weekly_digest(
    ...
    prompt_path: Path | str = Path("prompts/weekly_digest.txt"),
    ...
    taxonomy_md = read_text(outputs_dir / "taxonomy.md")
    comparison_rows = read_csv_rows(outputs_dir / "comparison_table.csv")
    trend_analysis_md = read_text(outputs_dir / "trend_analysis.md")
    ...
    latest_path = outputs_dir / "weekly_digest_latest.md"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--prompt_path", default="prompts/weekly_digest.txt")
