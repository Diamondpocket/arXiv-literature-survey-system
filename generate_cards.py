...
def generate_cards(
    raw_path: Path | str = Path("data/papers_raw.json"),
    cards_path: Path | str = Path("data/paper_cards.jsonl"),
    prompt_path: Path | str = Path("prompts/card_extraction.txt"),
    limit: int | None = None,
    batch_size: int = 1,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--raw_path", default="data/papers_raw.json")
    parser.add_argument("--cards_path", default="data/paper_cards.jsonl")
    parser.add_argument("--prompt_path", default="prompts/card_extraction.txt")
