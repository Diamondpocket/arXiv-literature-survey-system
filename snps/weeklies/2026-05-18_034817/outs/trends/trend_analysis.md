...
Generated at: 2026-05-18T03:47:45.825834+00:00
Evidence base: 307 structured paper cards.

## 分布观察 Observed Distribution
- Largest category / 最大类别: **核心检索与排序方法 (Core Retrieval and Ranking Methods)** (62 papers / 62 篇).
- Most frequent innovation type: **system_or_architecture** (151 papers).
- Confidence levels: {'high': 281, 'medium': 24, 'low': 2}.
- Data-driven signal: {'yes': 258, 'unknown': 42, 'partly': 7}.
...
- `retrieval`: 307 cards.
- `benchmark`: 154 cards.
- `evaluation`: 117 cards.
- `agent`: 85 cards.
- `domain`: 66 cards.
- `graph`: 54 cards.
- `hallucination`: 41 cards.
- `efficiency`: 37 cards.
...
- **Abstract-level evidence gap:** 42/307 cards do not specify datasets or scenarios, and 119/307 do not specify metrics. A stronger future survey can add full-text extraction for high-impact papers only, while keeping the abstract-only MVP reproducible.
