...
Generated at: 2026-04-27T07:50:42.636952+00:00
Evidence base: 127 structured paper cards.

## 分布观察 Observed Distribution
- Largest category / 最大类别: **智能体与多智能体 RAG (Agentic and Multi-Agent RAG)** (21 papers / 21 篇).
- Most frequent innovation type: **system_or_architecture** (65 papers).
- Confidence levels: {'high': 115, 'medium': 11, 'low': 1}.
- Data-driven signal: {'yes': 105, 'unknown': 22}.
...
- **Abstract-level evidence gap:** 22/127 cards do not specify datasets or scenarios, and 62/127 do not specify metrics. A stronger future survey can add full-text extraction for high-impact papers only, while keeping the abstract-only MVP reproducible.
