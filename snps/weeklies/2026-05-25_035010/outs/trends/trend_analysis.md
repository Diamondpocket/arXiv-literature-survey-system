...
Generated at: 2026-05-25T03:49:35.898359+00:00
Evidence base: 358 structured paper cards.

## 分布观察 Observed Distribution
- Largest category / 最大类别: **核心检索与排序方法 (Core Retrieval and Ranking Methods)** (71 papers / 71 篇).
- Most frequent innovation type: **system_or_architecture** (171 papers).
- Confidence levels: {'high': 324, 'medium': 32, 'low': 2}.
- Data-driven signal: {'yes': 300, 'unknown': 50, 'partly': 8}.
...
- `retrieval`: 358 cards.
- `benchmark`: 177 cards.
- `evaluation`: 137 cards.
- `agent`: 99 cards.
- `domain`: 84 cards.
- `graph`: 66 cards.
- `hallucination`: 49 cards.
- `efficiency`: 45 cards.
...
- **Abstract-level evidence gap:** 50/358 cards do not specify datasets or scenarios, and 138/358 do not specify metrics. A stronger future survey can add full-text extraction for high-impact papers only, while keeping the abstract-only MVP reproducible.
