...
Generated at: 2026-07-20T03:54:46.776515+00:00
Evidence base: 766 structured paper cards.

## 分布观察 Observed Distribution
- Largest category / 最大类别: **核心检索与排序方法 (Core Retrieval and Ranking Methods)** (146 papers / 146 篇).
- Most frequent innovation type: **system_or_architecture** (373 papers).
- Confidence levels: {'high': 684, 'medium': 78, 'low': 4}.
- Data-driven signal: {'yes': 646, 'unknown': 96, 'partly': 24}.
...
- `retrieval`: 766 cards.
- `benchmark`: 360 cards.
- `evaluation`: 288 cards.
- `agent`: 218 cards.
- `domain`: 185 cards.
- `graph`: 173 cards.
- `hallucination`: 101 cards.
- `efficiency`: 77 cards.
...
- **Abstract-level evidence gap:** 96/766 cards do not specify datasets or scenarios, and 307/766 do not specify metrics. A stronger future survey can add full-text extraction for high-impact papers only, while keeping the abstract-only MVP reproducible.
