...
Generated at: 2026-06-01T04:13:52.512689+00:00
Evidence base: 439 structured paper cards.

## 分布观察 Observed Distribution
- Largest category / 最大类别: **核心检索与排序方法 (Core Retrieval and Ranking Methods)** (81 papers / 81 篇).
- Most frequent innovation type: **system_or_architecture** (202 papers).
- Confidence levels: {'high': 395, 'medium': 42, 'low': 2}.
- Data-driven signal: {'yes': 368, 'unknown': 59, 'partly': 12}.
...
- `retrieval`: 439 cards.
- `benchmark`: 219 cards.
- `evaluation`: 164 cards.
- `agent`: 117 cards.
- `domain`: 106 cards.
- `graph`: 86 cards.
- `hallucination`: 59 cards.
- `efficiency`: 51 cards.
...
- **Abstract-level evidence gap:** 59/439 cards do not specify datasets or scenarios, and 177/439 do not specify metrics. A stronger future survey can add full-text extraction for high-impact papers only, while keeping the abstract-only MVP reproducible.
